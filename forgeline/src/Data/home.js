...
export const ourCard = [
	{
		id: "1",
		title: "Manufacturers",
		desc: "Generate demand by delivering the useful content that specifiers need.",
		imageUrl:
			"https://industrialstrengthmarketing.com/img/resized/manufacturers.webp",
		path: "",
	},
	{
		id: "2",
		title: "Distributors",
		desc: "Make it easier for industrial buyers to find and do business with you online.",
		imageUrl:
			"https://industrialstrengthmarketing.com/img/resized/distributors.webp",
		path: "/",
	},
	{
		id: "3",
		title: "Workforce Recruiters",
		desc: "Solve your recruiting, and retention with integrated marketing.",
		imageUrl:
			"https://industrialstrengthmarketing.com/img/resized/workforce-recruiters.webp",
		path: "/",
	},
];
...
export const serviceData = [
	{
		...
		desc: "Gain clarity on who you are and where you're going.",
		url: "https://industrialstrengthmarketing.com/img/icon-brand-strategy.svg",
	},

	{
		id: "2",
		title: "Sales Enablement",
		desc: "Align sales, marketing, and internal systems.",
		url: "https://industrialstrengthmarketing.com/img/icon-sales-enablement.svg",
	},

	{
		id: "3",
		title: "Integrated Marketing",
		desc: "Comprehensive marketing strategy and execution.",
		url: "https://industrialstrengthmarketing.com/img/icon-integrated-marketing.svg",
	},

	{
		id: "4",
		title: "Analytics & Insights",
		desc: "Measure performance and generate insights.",
		url: "https://industrialstrengthmarketing.com/img/icon-analytics.svg",
	},

	{
		id: "5",
		title: "Communicator",
		desc: "Turnkey lead generation for industrials.",
